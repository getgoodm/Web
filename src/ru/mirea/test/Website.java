...
public class Website extends HttpServlet{
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        List<String> lines = Files.readAllLines(Paths.get("D:\\Program Files\\labs\\web\\lab3\\log.txt"),StandardCharsets.UTF_8);
        ...
        PrintWriter printWriter = new PrintWriter("D:\\Program Files\\labs\\web\\lab3\\log.txt","UTF-8");
